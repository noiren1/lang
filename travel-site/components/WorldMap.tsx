...
const ISO_NUMERIC_TO_ALPHA2: Record<string, string> = {
  ...
  // Oceania
  '554': 'NZ', '598': 'PG', '242': 'FJ', '548': 'VU', '882': 'WS',
  // Europe extra
  '100': 'BG', '804': 'UA', '268': 'GE', '051': 'AM', '031': 'AZ',
  '112': 'BY', '233': 'EE', '428': 'LV', '440': 'LT', '703': 'SK',
  '442': 'LU', '499': 'ME', '807': 'MK', '070': 'BA', '008': 'AL',
  '196': 'CY',
  // Asia extra
  '682': 'SA', '398': 'KZ', '860': 'UZ', '417': 'KG', '496': 'MN',
  '586': 'PK', '050': 'BD', '462': 'MV', '064': 'BT', '344': 'HK',
  '446': 'MO', '364': 'IR',
  // Middle East extra
  '048': 'BH', '414': 'KW',
  // Africa extra
  '788': 'TN', '012': 'DZ', '288': 'GH', '686': 'SN', '516': 'NA',
  '508': 'MZ', '894': 'ZM', '716': 'ZW', '646': 'RW', '800': 'UG',
  '450': 'MG', '132': 'CV', '480': 'MU', '690': 'SC',
  // Americas extra
  '124': 'CA', '218': 'EC', '068': 'BO', '858': 'UY', '600': 'PY',
  '320': 'GT', '340': 'HN', '558': 'NI', '222': 'SV', '084': 'BZ',
  '388': 'JM', '214': 'DO', '780': 'TT',
}
